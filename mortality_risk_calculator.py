...
with nr:
    ...
    if st.button(f"{T['toggle_icon']}  {T['toggle_label']}",key="theme_btn",type="secondary",
    ...
    with tab3:
        ...
        with cha:
            ...
            for kd,kn in [(7,"D7"),(14,"D14"),(30,"D30")]:
                kv=mort_at(exp_s,kd)
                fig.add_vline(x=kd,line_dash="dot",line_color=f"{T['text_secondary']}66",line_width=1)
