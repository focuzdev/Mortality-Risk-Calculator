...
with nr:
    ...
    st.markdown(f"""
    <style>
    /* Make the theme button invisible but fully clickable over the pill */
    ...
    .theme-pill-wrap {{
        ...
        gap:10px; padding-top:16px; pointer-events:none;
    }}
    .t-label {{
        font-family:'DM Sans',sans-serif; font-size:13px; font-weight:600;
        color:{lbl_clr}; white-space:nowrap; letter-spacing:0.02em;
    }}
    .t-pill {{
    ...
    <div class="theme-pill-wrap">
      <span class="t-label">{lbl_text}</span>
