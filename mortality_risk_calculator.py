...
.stButton>button[kind="primary"]{{
  ...
  border-radius:12px !important;box-shadow:0 4px 18px {t["shadow_btn"]} !important;}}
...
/* ── Circular theme-toggle: scoped ONLY to the nav bar's last column ── */
[data-testid="stAppViewContainer"] > section > div > div:first-child [data-testid="stHorizontalBlock"] [data-testid="stColumn"]:last-child .stButton>button,
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button[title="Switch to Dark Mode"],
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button[title="Switch to Light Mode"]{{
  ...
  color:{t["teal"]} !important;box-shadow:none !important;
  display:flex !important;align-items:center !important;justify-content:center !important;
  margin-left:auto !important;transition:all 0.2s ease !important;}}
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button[title="Switch to Dark Mode"]:hover,
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button[title="Switch to Light Mode"]:hover{{
  background:{t["teal_glow"]} !important;box-shadow:0 0 14px {t["teal_glow"]} !important;
  transform:rotate(18deg) scale(1.1) !important;}}
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton{{
  display:flex !important;justify-content:flex-end !important;padding-top:8px !important;}}
...
with nav_left:
    st.markdown(f"""
    <div class="icu-nav-left" style="padding:6px 0;">
      <div class="icu-logo">
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with a2:
        ...
        for var, typ, beta, se, note in [
            ...
            ("CFS Score",              "1–9 scale",    "+0.0598", "±0.028", "Frailty"),
