...
@media screen and (max-width:768px){{
  ...
  .stepper-wrap{{flex-direction:column !important;align-items:flex-start !important;
  ...
  .step-label{{font-size:13px !important;}}
  .step-circle{{width:38px !important;height:38px !important;font-size:14px !important;}}
  .icu-card{{padding:18px !important;border-radius:12px !important;}}
  .icu-stat{{padding:16px !important;}}
  .icu-stat .val{{font-size:28px !important;}}
  .icu-stat .lbl{{font-size:12px !important;}}
  .risk-banner{{padding:18px 20px !important;}}
  .mchip{{padding:16px !important;}}
  .mchip .mv{{font-size:24px !important;}}
  .mchip .ml{{font-size:11px !important;}}
  h1{{font-size:30px !important;line-height:1.2 !important;}}
  .cci-badge{{min-width:120px !important;padding:12px 16px !important;}}
  .cb-val{{font-size:26px !important;}}
  .stButton>button{{font-size:14px !important;padding:11px 18px !important;}}
...
@media screen and (max-width:480px){{
  ...
  .step-label{{font-size:12px !important;letter-spacing:0.03em !important;}}
    ...
    with hr:
        ...
        for rl, cfg in RISK_CFG.items():
            ...
            <div class="ref-row">
              ...
              <div>
                <div style="font-family:'Space Grotesk',sans-serif;font-size:15px;font-weight:700;color:{cfg["color"]};">
                  {rl} <span style="color:{T["text_secondary"]};font-weight:400;font-size:14px;">({cfg["band"]})</span></div>
                <div style="font-size:14px;color:{T["text_secondary"]};margin-top:3px;line-height:1.6;">{cfg["rec"][:80]}...</div>
              </div>
            </div>""", unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # ════════════════════════════════════════════════════════════════════════
        ...
        # ── Full day table ────────────────────────────────────────────────
        with st.expander("📋 Full Day-by-Day Survival & Mortality Table — All 25 Time Points"):
            st.markdown(f"""
