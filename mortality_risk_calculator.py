...
.stButton>button[kind="secondary"]{{
  background:{t["card_bg"]} !important;border:1.5px solid {t["border"]} !important;
  color:{t["text_primary"]} !important;padding:14px 30px !important;
  border-radius:24px !important;box-shadow:none !important;}}
.stButton>button[kind="secondary"]:hover{{
  border-color:{t["teal"]} !important;color:{t["teal"]} !important;
  background:{t["card_bg"]} !important;transform:translateY(-1px) !important;}}
.stButton>button[kind="secondary"] p{{
  color:inherit !important;margin:0 !important;}}

/* ── Circular theme-toggle button in nav right column ── */
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button{{
...
div[data-testid="stHorizontalBlock"]:first-of-type div[data-testid="stColumn"]:last-child .stButton>button:hover{{
            ...
            <div style="background:{T["card_bg"]};border:1px solid {T["border"]};
              ...
              <div style="margin-top:18px;padding:14px;background:{rc['bg']};
                ...
                <div style="font-size:13px;color:{rc['color']};font-weight:700;margin-bottom:6px;">
                  {{"LOW":"Favourable prognosis","MODERATE":"Cautious prognosis","HIGH":"Guarded prognosis","VERY HIGH":"Poor prognosis"}.get(rl, "")}
                </div>
